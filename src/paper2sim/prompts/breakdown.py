...
{"document_title": "Paper title", "document_summary": "2-3 sentence overview", "topics":
[{"name": "Engaging topic title", "summary": "2-3 sentence hook for video intro",
"full_explanation": "Self-contained explanation in plain text, 2-4 paragraphs. Define all terms.
Cover the core idea, why it matters, and modern context.",
